...
(function () {
      ...
      try {
        while (true) {
          ...
          try {
            ...
            setTimeout(triggerUsageFetch, 400);
            break;
          }
          ...
          if (done) {
            ...
            // Trigger usage fetch on stream completion to ensure usage is up-to-date
            setTimeout(triggerUsageFetch, 500);
            break;
          }
  ...
  async function triggerUsageFetch(retries = 2, delay = 1000) {
